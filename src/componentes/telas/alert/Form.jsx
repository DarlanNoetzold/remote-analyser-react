...
function Form() {
  ...
  return (
    <Dialogo id="modalEdicao" titulo="Categoria" idformulario="formEdicao" acaoCadastrar={acaoCadastrar}>
      ...
      <CampoEntrada id="txtImageId" label="ImageId" tipo="number" name="ImageId" value={objeto.image.id} handlechange={handleChange} requerido={true} readonly={false} textovalido="ImageId OK" textoinvalido="Informe o ImageId" maximocaracteres={40} />
